<?php
	...
	define("raiz","/coruja/"); // insira aqui a pasta de instalação do script
	//define("raiz","/"); // Raíz
	ob_end_flush();
?>
<!DOCTYPE html>
				...
				<header>
					<div id="conteudo" class="col-md-12">
						...
						<?php
							...
							$permissao = array('home','clientes','aniversariantes','404','agenda','financeiro','procedimentos','logout');
							$pasta = 'paginas';
